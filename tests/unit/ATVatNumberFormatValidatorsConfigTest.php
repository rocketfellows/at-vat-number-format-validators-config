...
namespace rocketfellows\ATVatNumberFormatValidatorsConfig\tests\unit;
...
class ATVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = ATVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = ATVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::AT(), $config->getCountry());
    }
